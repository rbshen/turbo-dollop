...
/** Settings "Status" section -- Data Sources (FMP + Yahoo Finance health
 * cards) then Scheduled Jobs, replacing the old site-wide FmpPausedBanner/
 * CronHealthBanner entirely (see app/layout.tsx, both deleted). */
