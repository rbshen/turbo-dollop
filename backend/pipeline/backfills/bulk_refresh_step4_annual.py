...
Run against a small subset first (recommended before the full list):
    uv run python -m pipeline.backfills.bulk_refresh_step4_annual --limit 15
    uv run python -m pipeline.backfills.bulk_refresh_step4_annual --tickers AAPL,MSFT,ZZZZINVALID

Run against the full stored S&P 500 list:
    uv run python -m pipeline.backfills.bulk_refresh_step4_annual
"""
