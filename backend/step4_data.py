...
async def get_step4_data(ticker: str) -> Step4Out:
    ...
    # software"). Deliberately checked on the annual history only, not the
    # latest-quarter snapshot appended below: FMP's quarterly inventory
    # figure has proven unreliable for inventory-free companies (e.g. MA
    # shows +$2.06B, NOW shows -$28M in their latest quarter despite 5
    # straight clean-zero annual years) -- a likely data-provider
