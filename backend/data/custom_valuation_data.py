...
def run_manual_calculation_from_params(method: str, params: Step3ManualParams, last_close: float | None) -> ManualCalculationResult:
    ...
    return run_manual_calculation(
        ...
        book_value_per_share_standard=params.book_value_per_share_standard,
        pb_mean_ratio_standard=params.pb_mean_ratio_standard,
        pb_sd_ratio_standard=params.pb_sd_ratio_standard,
